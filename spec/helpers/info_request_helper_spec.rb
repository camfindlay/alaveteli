  ...
  describe '#awaiting_description_text' do
    ...
    context 'external request' do
      it_behaves_like 'when we can\'t ask the user to update the status' do
        ...
        let(:message) do
          awaiting_description_text(info_request, true, false, false, 1)
        end
        let(:plural_message) do
          awaiting_description_text(info_request, true, false, false, 3)
        end
      end
    end
    ...
    context 'rendering to a file' do
      it_behaves_like 'when we can\'t ask the user to update the status' do
        let(:message) do
          awaiting_description_text(info_request, true, true, false, 1)
        end
        let(:plural_message) do
          awaiting_description_text(info_request, true, true, false, 3)
        end
      end
    end
    ...
    context 'non-owner viewing a recent request' do
      it_behaves_like 'when we can\'t ask the user to update the status' do
        let(:message) do
          awaiting_description_text(info_request, false, false, false, 1)
        end
        let(:plural_message) do
          awaiting_description_text(info_request, false, false, false, 3)
        end
      end
    end
